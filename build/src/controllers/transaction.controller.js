...
let TransactionController = class TransactionController {
    getTransactions() {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, transaction_repository_1.getTransactions)();
        });
    }
    getTransaction(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, transaction_repository_1.getTransaction)(Number(id));
        });
    }
    createTransaction(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, transaction_repository_1.createTransaction)(body);
        });
    }
};
__decorate([
