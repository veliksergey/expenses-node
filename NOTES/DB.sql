...
INSERT INTO vendor (id, "name") VALUES (1, 'walmart'), (2, 'home depot'), (3, 'victor'), (4, 'lowes'), (5, 'PGE'), (6, 'Integrify');
INSERT INTO transaction
    ("id", "type", "name", "amount", "relatedAmount", "date", "relatedDate", "nonTaxable", "notes", "accountId", "categoryId", "personId", "projectId", "vendorId")
    VALUES
    (1, 0, 'electricity', 243.54, 0, '2022-01-05', '2022-01-08', false, 'paying bill for electricity', 1, 5, 1, 1, 5),
    ...
    (4, 0, 'N', 0, null, '2020-02-20', null, false, null, null, null, null, 2, 2),
    (5, 1, 'salary', 3569, null, '2020-02-1', null, false, 'Integrify', 1, 2, null, 3, 6);
